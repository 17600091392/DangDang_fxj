...
<html>
	...
	<body>
		...
		<table width="80%" border="0" align="center" cellspacing="0" cellpadding="5">
			...
			<tr>
				<td>出版时间：<fml:formatDate value="${book.press_date}" pattern="yyyy-MM-dd"/> </td>
			...
			<tr>
				<td>印刷时间：<fml:formatDate value="${book.print_date}" pattern="yyyy-MM-dd"/></td>
				<td>开本：${book.sizes}</td>
			</tr>
			<tr>
