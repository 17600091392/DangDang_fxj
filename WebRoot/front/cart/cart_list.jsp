	...
	<head>
		...
		<script type="text/javascript">
			function update(id) {
				var num=$("#"+id).val();
				if (num>0) {
					window.location.href="${pageContext.request.contextPath}/cartitem/updateCart?id="+id+"&count="+num
				}
			}
		</script>
			...
			<div class="choice_bord">
				<table class="tabl_buy" id="tbCartItemsNormal">
					...
					<tr class='td_no_bord'>
						...
						<td>
							<a href="">${cartitem.value.book.name}</a>
						</td>
						<td class="buy_td_5">
						...
						<td class="buy_td_4">
							&nbsp;&nbsp;
							<span>￥${cartitem.value.book.dprice}</span>
						</td>
						<td class="buy_td_1">
						...
						<td >
							<input id="${cartitem.key}" class="del_num" type="number" size="3" maxlength="4" />
							<a href="#" onclick="update('${cartitem.key}')">变更</a>
						</td>
						<td>
							<a href="${pageContext.request.contextPath}/cartitem/deleteCart?id=${cartitem.value.book.id}">删除</a>
						</td>
					</tr>
					</c:forEach>
				</table>
