	...
	<body>
		...
		<div class="fill_message">
			...
			<table class="tab_login">
				...
				<c:forEach items="${sessionScope.cart}" var="cartItem">
					<tr>
						...
						<td valign="top">
							${cartItem.value.book.name}
						</td>
						<td valign="top">
							${cartItem.value.book.dprice}
						</td>
						<td valign="top">
							${cartItem.value.count}
						</td>
						<td valign="top">
							${cartItem.value.book.dprice * cartItem.value.count}
						</td>
					</tr>
				</c:forEach>
				<!-- 订单结束 -->
			...
			<div class="login_in">
				...
				<a href="${pageContext.request.contextPath}/address/selectAddress?addressId=">
