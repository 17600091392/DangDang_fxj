...
<body style="background-color: #f0f9fd;text-align: center">
	...
	<form action="${pageContext.request.contextPath}/book/updateBook" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" name="book.create_date" value='<fmt:formatDate value="${book.create_date}" pattern="yyyy-MM-dd"/>'>
			<table>
				<tr>
					<td>名称：</td>
					<td>
					<input type="text" name="book.name" class="el-input__inner" value="${book.name}"></td>
