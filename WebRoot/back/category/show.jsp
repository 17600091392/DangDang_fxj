...
<%@ page language="java" import="com.baizhi.entity.Category"%>
<html>
	<head>
	...
	<body style="background-color: #f0f9fd;text-align: center;">
		...
		<div style="margin-bottom: 10px;">
			...
			<div class="button btn-p" onclick="location.href='${pageContext.request.contextPath}/category/selectFirst'">添加二级类别&raquo;</div>
		</div>
